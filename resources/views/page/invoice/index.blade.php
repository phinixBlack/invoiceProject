                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="exampleFormControlSelect1"
                                    aria-label="Default select example" name="item_id" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="exampleFormControlSelect1"
                                    aria-label="Default select example" name="port_loading_id" required>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="exampleFormControlSelect1"
                                    aria-label="Default select example" name="buyer_id" placeholder="Buyer" required>

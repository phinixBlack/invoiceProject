...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Package Type Tab</h4>
        <div class="row">
            <div class="card">
                    ...
                    <div class="modal-content">
                        ...
                        <form id="itemForm" class="mb-3" action="#" method="POST">
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col mb-3">
                                        <label for="nameBasic" class="form-label"> Package Type Name</label>
        ...
        <div class="mt-3">
            ...
            <div class="modal fade" id="editModule" tabindex="-1" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel1">Edit  Package Type</h5>
                            <button type="button" class="btn-close addItem" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <form id="itemEdit" class="mb-3" action="#" method="POST">
                            ...
                            <div class="modal-body">
                                <div class="row">
                                    <div class="col mb-3">
                                        <label for="nameBasic" class="form-label"> Package Type Name</label>
                                        <input type="text" id="packageTypeName" class="form-control" name="name"
                                            placeholder="Enter Item Name" />
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '.statusChange', function() {
                ...
                $.ajax({
                    url: "{{ route('packageType.edit.status') }}",
                    type: "post",
                    data: fd,
                    dataType: "JSON",
                    processData: false,
            ...
            $('body').on('click', '.deltePackageType', function() {
            ...
            $('body').on('click', '.editPackageType', function() {

                let body = $(this).parent();
                let id = $(this).data('id');
                let name = $(this).data('name');
                $('#packageTypeId').val(id);
                $('#packageTypeName').val(name);

...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row" style="margin: 10px">
            <form id="customer_create" action="#" method="POST">
                            ...
                            <div class="card mb-4" style="padding:2px">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="defaultInput" class="form-control" type="text" name="country"
                                            placeholder="Enter Country..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">Customer State</label>
                                        <input id="defaultInput" class="form-control" type="text" name="state"
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="defaultInput" class="form-control" type="text" name="bank_name"
                                            placeholder="Enter Bank Name..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">Bank Address</label>
                                        <input id="defaultInput" class="form-control" type="text" name="bank_address"
                                            placeholder="Enter Bank Address..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">Account No</label>
                                        <input id="defaultInput" class="form-control" type="text" name="account_no"
                                            placeholder="Enter Account No..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">Swift No</label>
                                        <input id="defaultInput" class="form-control" type="text" name="swift_no"
                                            placeholder="Enter Swift No..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">IBAN No</label>
                                        <input id="defaultInput" class="form-control" type="text" name="IBAN_no"
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input id="defaultInput" class="form-control" type="text" name="incoterms"
                                            placeholder="Enter Incoterms..." />
                                    </div>
                                    <div class="mb-3">
                                        <label for="defaultInput" class="form-label">HS Code</label>
                                        <input id="defaultInput" class="form-control" type="text" name="HS_code"

                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="defaultInput" class="form-control" type="text" placeholder="write...." value="{{$company->city}}" 
                                    name="city"  />
                            </div>
                          
                            <div class="mb-3">
                                <label for="defaultInput" class="form-label">Country</label>
                                <input id="defaultInput" class="form-control" type="text" placeholder="write...." value="{{$company->country}}" 
                                    name="country"  />
                            </div>
                            <div class="mb-3">
                                <label for="defaultInput" class="form-label">Pin Code</label>
                                <input id="defaultInput" class="form-control" type="text" placeholder="write...." value="{{$company->pin_code}}" 
                                    name="pin_code"  />
                            </div>
                            <div class="mb-3">
                                <label for="defaultSelect" class="form-label">Address</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="address" > {{$company->address}}</textarea>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" value="" id="html5-date-input" value="{{$company->account_no}}" 
                                    name="account_no" placeholder="Invoice date" />
                            </div>
                            <div class="mb-3">
                                <label for="defaultSelect" class="form-label">Bank Name</label>
                                <input id="defaultInput" class="form-control" type="text" placeholder="write...." value="{{$company->bank_name}}" 
                                    name="bank_name" />
                            </div>
                            
                            <div class="mb-3">
                                <label for="defaultSelect" class="form-label">Swift Code</label>
                                <input class="form-control" type="text" value="" id="html5-date-input" value="{{$company->swift_code}}" 
                                    name="swift_code" placeholder="Invoice date" />
                            </div>
                           
                            <div class="mb-3">
                                <label for="defaultSelect" class="form-label">IFSC</label>
                                <input id="defaultInput" class="form-control" type="text" placeholder="write...." value="{{$company->ifsc}}" 
                                    name="ifsc" />

                            </div>
                            <div class="mb-3">
                                <label for="defaultSelect" class="form-label">Bank Address</label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="bank_address" > {{$company->bank_address}}</textarea>

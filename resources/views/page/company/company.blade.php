...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Forms /</span>Company Tab</h4>
        <div class="row" style="margin: 10px">
            <div class="card">
                <div class="row card-header">
                    ...
                    <div class="col align-self-end "> <a href="{{ route('company.create.index') }}" class="btn btn-primary"

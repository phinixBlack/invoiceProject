<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            <a href="{{ route('item.index') }}" class="menu-link" style="text-decoration: none;{{Route::current()->getName() ==="item.index" ?"background-color: rgba(67, 89, 113, 0.04)":""}}">
       ...
       <li class="menu-item">
          <a href="{{ route('invoice.invoice.index') }}" class="menu-link" style="text-decoration: none ;{{Route::current()->getName() ==="invoice.invoice.index" ?"background-color: rgba(67, 89, 113, 0.04)":""}} "  >
              <i class="menu-icon tf-icons bx bx-detail"></i>
              <div data-i18n="Analytics">Invoice</div>
          </a>
      </li>
      <li class="menu-item">
        <a href="{{ route('freight.freight.index') }}" class="menu-link" style="text-decoration: none ;{{Route::current()->getName() ==="freight.freight.index" ?"background-color: rgba(67, 89, 113, 0.04)":""}} "  >
            <i class="menu-icon tf-icons bx bx-detail"></i>
